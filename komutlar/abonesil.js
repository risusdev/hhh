...
if(!abonerol) return message.channel.send(`Abone rolü ayarlanmamış! Ayarlamak İçin r!abone-rol @Rol`)
  ...
  message.channel.send(`Kullanıcıdan abone rolünü başarıyla aldın :white_check_mark: `)
  const embed = new Discord.MessageEmbed()
  .setTitle(`Abone Rolü Alındı!`)
  .addField(`Abone Rolünü Alan Kişi:`, `Adı:${message.author.tag} İD:${message.author.id}`, true)
